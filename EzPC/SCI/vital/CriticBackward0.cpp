...
vector < vector < FPArray > > layer3WDerReshaped = make_vector_float(ALICE, 128, 1) ;

vector < FPArray > layer3bDer = make_vector_float(ALICE, 1) ;

vector < vector < FPArray > > layer2ActDer = make_vector_float(ALICE, 128, 128) ;

getOutDer(128, 1, fwdOut, target, layer3Der);
Transpose(128, 128, layer3In, layer3InReshaped);
MatMul(128, 128, 1, layer3InReshaped, layer3Der, layer3WDerReshaped);
getBiasDer(128, 1, layer3Der, layer3bDer);
...
vector < vector < FPArray > > layer1InReshaped = make_vector_float(ALICE, 14, 128) ;

vector < vector < FPArray > > layer1WDerReshaped = make_vector_float(ALICE, 14, 128) ;

vector < FPArray > layer1bDer = make_vector_float(ALICE, 128) ;

IfElse2(128, 128, layer1ActDer, layer1ReluHot, layer1Der, 1);
Transpose(14, 128, layer1In, layer1InReshaped);
MatMul(14, 128, 128, layer1InReshaped, layer1Der, layer1WDerReshaped);
getBiasDer(128, 128, layer1Der, layer1bDer);
vector < vector < FPArray > > layer1WDer = make_vector_float(ALICE, 128, 14) ;

vector < vector < FPArray > > layer2WDer = make_vector_float(ALICE, 128, 128) ;

vector < vector < FPArray > > layer3WDer = make_vector_float(ALICE, 1, 128) ;

Transpose(128, 14, layer1WDerReshaped, layer1WDer);
Transpose(128, 128, layer2WDerReshaped, layer2WDer);
Transpose(1, 128, layer3WDerReshaped, layer3WDer);
updateWeightsAdam2(128, 14, layer1WT, 0.001, 0.9, 0.999, 1e-08, layer1W, layer1WDer, layer1WM, layer1WV);
updateWeightsAdam(128, layer1bT, 0.001, 0.9, 0.999, 1e-08, layer1b, layer1bDer, layer1bM, layer1bV);
updateWeightsAdam2(128, 128, layer2WT, 0.001, 0.9, 0.999, 1e-08, layer2W, layer2WDer, layer2WM, layer2WV);
updateWeightsAdam(128, layer2bT, 0.001, 0.9, 0.999, 1e-08, layer2b, layer2bDer, layer2bM, layer2bV);
updateWeightsAdam2(1, 128, layer3WT, 0.001, 0.9, 0.999, 1e-08, layer3W, layer3WDer, layer3WM, layer3WV);
updateWeightsAdam(1, layer3bT, 0.001, 0.9, 0.999, 1e-08, layer3b, layer3bDer, layer3bM, layer3bV);
}
...
vector < vector < FPArray > > target = make_vector_float(ALICE, 128, 1) ;
...
target[i0][i1] = __fp_op->input(ALICE, 1, __tmp_in_target, __m_bits, __e_bits) ;
...
vector < vector < FPArray > > layer1WM = make_vector_float(ALICE, 128, 14) ;
...
vector < vector < FPArray > > layer3WM = make_vector_float(ALICE, 1, 128) ;
...
vector < FPArray > layer3bM = make_vector_float(ALICE, 1) ;
...
vector < vector < FPArray > > layer1WV = make_vector_float(ALICE, 128, 14) ;
...
vector < vector < FPArray > > layer3WV = make_vector_float(ALICE, 1, 128) ;
...
vector < FPArray > layer3bV = make_vector_float(ALICE, 1) ;
...
vector < vector < FPArray > > layer1WT = make_vector_float(ALICE, 128, 14) ;
...
vector < vector < FPArray > > layer3WT = make_vector_float(ALICE, 1, 128) ;
...
vector < FPArray > layer3bT = make_vector_float(ALICE, 1) ;
...
backward(layer1WT, layer1bT, layer2WT, layer2bT, layer3WT, layer3bT, target, fwdOut, layer1W, layer1b, layer2W, layer2b, layer3W, layer3b, layer1WM, layer1bM, layer2WM, layer2bM, layer3WM, layer3bM, layer1WV, layer1bV, layer2WV, layer2bV, layer3WV, layer3bV, inp, layer1ReluHot, layer1Out, layer2In, layer2ReluHot, layer2Out, layer3In);
if ((__party == ALICE)) {
