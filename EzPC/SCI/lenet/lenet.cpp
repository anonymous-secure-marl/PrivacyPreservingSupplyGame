...
extern void MaxPool(int32_t N, int32_t H, int32_t W, int32_t C, int32_t ksizeH, int32_t ksizeW, int32_t imgH, int32_t imgW, vector < vector < vector < vector < FPArray > > > >& inArr, vector < vector < vector < vector < BoolArray > > > >& Pool, vector < vector < vector < vector < FPArray > > > >& outArr);
...
vector < vector < vector < vector < FPArray > > > > layer1Tmp = make_vector_float(ALICE, 256, 28, 28, 6) ;

Conv2DGroupWrapper(256, 32, 32, 3, 5, 5, 6, 0, 0, 0, 0, 1, 1, 1, layer1In, layer1W, layer1Tmp);
ConvAdd(256, 28, 28, 6, layer1Tmp, layer1b, layer1Tmp);
Relu4(256, 28, 28, 6, layer1Tmp, layer1Out, layer1Hot);
MaxPool(256, 28, 28, 6, 2, 2, 14, 14, layer1Out, layer1Pool, layer2In);
vector < vector < vector < vector < FPArray > > > > layer2Tmp = make_vector_float(ALICE, 256, 10, 10, 16) ;

Conv2DGroupWrapper(256, 14, 14, 6, 5, 5, 16, 0, 0, 0, 0, 1, 1, 1, layer2In, layer2W, layer2Tmp);
ConvAdd(256, 10, 10, 16, layer2Tmp, layer2b, layer2Tmp);
Relu4(256, 10, 10, 16, layer2Tmp, layer2Out, layer2Hot);
vector < vector < vector < vector < FPArray > > > > layerLastPool = make_vector_float(ALICE, 256, 5, 5, 16) ;

MaxPool(256, 10, 10, 16, 2, 2, 5, 5, layer2Out, layer2Pool, layerLastPool);
Flatten(256, 5, 5, 16, 256, 400, layerLastPool, layer3In);
vector < vector < FPArray > > layer3WReshaped = make_vector_float(ALICE, 400, 120) ;

vector < vector < FPArray > > layer3Temp = make_vector_float(ALICE, 256, 120) ;

Transpose(400, 120, layer3W, layer3WReshaped);
MatMul(256, 400, 120, layer3In, layer3WReshaped, layer3Temp);
GemmAdd(256, 120, layer3Temp, layer3b, layer3Out);
Relu2(256, 120, layer3Out, layer4In, layer3Hot);
vector < vector < FPArray > > layer4WReshaped = make_vector_float(ALICE, 120, 84) ;

vector < vector < FPArray > > layer4Temp = make_vector_float(ALICE, 256, 84) ;

Transpose(120, 84, layer4W, layer4WReshaped);
MatMul(256, 120, 84, layer4In, layer4WReshaped, layer4Temp);
GemmAdd(256, 84, layer4Temp, layer4b, layer4Out);
Relu2(256, 84, layer4Out, layer5In, layer4Hot);
vector < vector < FPArray > > layer5WReshaped = make_vector_float(ALICE, 84, 10) ;

vector < vector < FPArray > > layer5Temp = make_vector_float(ALICE, 256, 10) ;

Transpose(84, 10, layer5W, layer5WReshaped);
MatMul(256, 84, 10, layer5In, layer5WReshaped, layer5Temp);
GemmAdd(256, 10, layer5Temp, layer5b, layer5Temp);
Softmax2(256, 10, layer5Temp, fwdOut);
}

void backward(vector < vector < vector < vector < FPArray > > > >& layer1W, vector < FPArray >& layer1b, vector < vector < vector < vector < FPArray > > > >& layer2W, vector < FPArray >& layer2b, vector < vector < FPArray > >& layer3W, vector < FPArray >& layer3b, vector < vector < FPArray > >& layer4W, vector < FPArray >& layer4b, vector < vector < FPArray > >& layer5W, vector < FPArray >& layer5b, vector < vector < vector < vector < FPArray > > > >& layer1In, vector < vector < vector < vector < BoolArray > > > >& layer1Hot, vector < vector < vector < vector < FPArray > > > >& layer1Out, vector < vector < vector < vector < BoolArray > > > >& layer1Pool, vector < vector < vector < vector < FPArray > > > >& layer2In, vector < vector < vector < vector < BoolArray > > > >& layer2Hot, vector < vector < vector < vector < FPArray > > > >& layer2Out, vector < vector < vector < vector < BoolArray > > > >& layer2Pool, vector < vector < FPArray > >& layer3In, vector < vector < BoolArray > >& layer3Hot, vector < vector < FPArray > >& layer3Out, vector < vector < FPArray > >& layer4In, vector < vector < BoolArray > >& layer4Hot, vector < vector < FPArray > >& layer4Out, vector < vector < FPArray > >& layer5In, vector < vector < FPArray > >& fwdOut, vector < vector < FPArray > >& target){
vector < vector < FPArray > > layer5Der = make_vector_float(ALICE, 256, 10) ;

vector < vector < FPArray > > layer5InReshaped = make_vector_float(ALICE, 84, 256) ;
...
vector < vector < FPArray > > layer4ActDer = make_vector_float(ALICE, 256, 84) ;

getOutDer(256, 10, fwdOut, target, layer5Der);
Transpose(84, 256, layer5In, layer5InReshaped);
MatMul(84, 256, 10, layer5InReshaped, layer5Der, layer5WDerReshaped);
getBiasDer(256, 10, layer5Der, layer5bDer);
MatMul(256, 10, 84, layer5Der, layer5W, layer4ActDer);
vector < vector < FPArray > > layer4Der = make_vector_float(ALICE, 256, 84) ;

vector < vector < FPArray > > layer4InReshaped = make_vector_float(ALICE, 120, 256) ;
...
vector < vector < FPArray > > layer3ActDer = make_vector_float(ALICE, 256, 120) ;

IfElse2(256, 84, layer4ActDer, layer4Hot, layer4Der, 1);
Transpose(120, 256, layer4In, layer4InReshaped);
MatMul(120, 256, 84, layer4InReshaped, layer4Der, layer4WDerReshaped);
getBiasDer(256, 84, layer4Der, layer4bDer);
MatMul(256, 84, 120, layer4Der, layer4W, layer3ActDer);
vector < vector < FPArray > > layer3Der = make_vector_float(ALICE, 256, 120) ;

vector < vector < FPArray > > layer3InReshaped = make_vector_float(ALICE, 400, 256) ;
...
vector < vector < FPArray > > flatActDer = make_vector_float(ALICE, 256, 400) ;

vector < vector < vector < vector < FPArray > > > > layer2PooledDer = make_vector_float(ALICE, 256, 5, 5, 16) ;

IfElse2(256, 120, layer3ActDer, layer3Hot, layer3Der, 1);
Transpose(400, 256, layer3In, layer3InReshaped);
MatMul(400, 256, 120, layer3InReshaped, layer3Der, layer3WDerReshaped);
getBiasDer(256, 120, layer3Der, layer3bDer);
MatMul(256, 120, 400, layer3Der, layer3W, flatActDer);
vector < vector < vector < vector < FPArray > > > > layer2ExpandedPooledDer = make_vector_float(ALICE, 256, 10, 10, 16) ;

vector < vector < vector < vector < FPArray > > > > layer2ActDer = make_vector_float(ALICE, 256, 10, 10, 16) ;

vector < vector < vector < vector < FPArray > > > > layer2Der = make_vector_float(ALICE, 256, 10, 10, 16) ;
...
vector < vector < vector < vector < FPArray > > > > layer1PooledDer = make_vector_float(ALICE, 256, 14, 14, 6) ;

Unflatten(256, 400, 256, 5, 5, 16, flatActDer, layer2PooledDer);
PoolExpand(256, 5, 5, 16, 2, 2, 10, 10, layer2PooledDer, layer2ExpandedPooledDer);
IfElse4(256, 10, 10, 16, layer2ExpandedPooledDer, layer2Pool, layer2ActDer, 0);
IfElse4(256, 10, 10, 16, layer2ActDer, layer2Hot, layer2Der, 1);
ConvDerWrapper(256, 14, 14, 6, 5, 5, 16, 0, 0, 0, 0, 1, 1, 1, layer2In, layer2WDer, layer2Der);
ConvBiasDer(256, 10, 10, 16, layer2Der, layer2bDer);
GetPooledDer(256, 14, 14, 6, 16, 10, 10, 5, 5, layer2W, layer2Der, layer1PooledDer);
vector < vector < vector < vector < FPArray > > > > layer1ExpandedPooledDer = make_vector_float(ALICE, 256, 28, 28, 6) ;

vector < vector < vector < vector < FPArray > > > > layer1ActDer = make_vector_float(ALICE, 256, 28, 28, 6) ;

vector < vector < vector < vector < FPArray > > > > layer1Der = make_vector_float(ALICE, 256, 28, 28, 6) ;
...
PoolExpand(256, 14, 14, 6, 2, 2, 28, 28, layer1PooledDer, layer1ExpandedPooledDer);
IfElse4(256, 28, 28, 6, layer1ExpandedPooledDer, layer1Pool, layer1ActDer, 0);
IfElse4(256, 28, 28, 6, layer1ActDer, layer1Hot, layer1Der, 1);
ConvDerWrapper(256, 32, 32, 3, 5, 5, 6, 0, 0, 0, 0, 1, 1, 1, layer1In, layer1WDer, layer1Der);
ConvBiasDer(256, 28, 28, 6, layer1Der, layer1bDer);
...
Transpose(120, 400, layer4WDerReshaped, layer4WDer);
Transpose(120, 400, layer5WDerReshaped, layer5WDer);
updateWeights4(5, 5, 3, 6, 0.01, layer1W, layer1WDer);
updateWeights(6, 0.01, layer1b, layer1bDer);
updateWeights4(5, 5, 3, 6, 0.01, layer2W, layer2WDer);
updateWeights(6, 0.01, layer2b, layer2bDer);
updateWeights2(120, 400, 0.01, layer3W, layer3WDer);
updateWeights(120, 0.01, layer3b, layer3bDer);
updateWeights2(120, 400, 0.01, layer4W, layer4WDer);
updateWeights(120, 0.01, layer4b, layer4bDer);
updateWeights2(120, 400, 0.01, layer5W, layer5WDer);
updateWeights(120, 0.01, layer5b, layer5bDer);
}
...
vector < vector < vector < vector < FPArray > > > > inp = make_vector_float(ALICE, 256, 32, 32, 3) ;
...
vector < vector < FPArray > > target = make_vector_float(ALICE, 256, 10) ;
...
vector < vector < vector < vector < FPArray > > > > layer1In = make_vector_float(ALICE, 256, 32, 32, 3) ;

vector < vector < vector < vector < BoolArray > > > > layer1Hot = make_vector_bool(ALICE, 256, 28, 28, 6) ;

vector < vector < vector < vector < FPArray > > > > layer1Out = make_vector_float(ALICE, 256, 28, 28, 6) ;

vector < vector < vector < vector < BoolArray > > > > layer1Pool = make_vector_bool(ALICE, 256, 28, 28, 6) ;

vector < vector < vector < vector < FPArray > > > > layer2In = make_vector_float(ALICE, 256, 14, 14, 6) ;

vector < vector < vector < vector < BoolArray > > > > layer2Hot = make_vector_bool(ALICE, 256, 10, 10, 16) ;

vector < vector < vector < vector < FPArray > > > > layer2Out = make_vector_float(ALICE, 256, 10, 10, 16) ;

vector < vector < vector < vector < BoolArray > > > > layer2Pool = make_vector_bool(ALICE, 256, 10, 10, 16) ;

vector < vector < FPArray > > layer3In = make_vector_float(ALICE, 256, 400) ;

vector < vector < BoolArray > > layer3Hot = make_vector_bool(ALICE, 256, 120) ;

vector < vector < FPArray > > layer3Out = make_vector_float(ALICE, 256, 120) ;

vector < vector < FPArray > > layer4In = make_vector_float(ALICE, 256, 120) ;

vector < vector < BoolArray > > layer4Hot = make_vector_bool(ALICE, 256, 84) ;

vector < vector < FPArray > > layer4Out = make_vector_float(ALICE, 256, 84) ;

vector < vector < FPArray > > layer5In = make_vector_float(ALICE, 256, 84) ;

vector < vector < FPArray > > fwdOut = make_vector_float(ALICE, 256, 10) ;
...
computeCELoss(256, 10, target, fwdOut, loss);
FPArray __tac_var162 = loss[0] ;

cout << "Value of __tac_var162 : " ;

__fp_pub = __fp_op->output(PUBLIC, __tac_var162) ;
