...
def train_marl(world, ac_nns, optimizers, memories, max_epochs, max_steps, 
    ...
    f2 = open("SupplyGameResults/SupplyGameRealExecutionResults/Player0/sample_policies_result_Player0.txt","r")
    g2 = open("SupplyGameRealExecutionResults/Player1/sample_policies_result_Player1.txt","r")
        ...
        for step in range(max_steps):
            ...
            if world.player_num == 1:
                ...
                if raw_mat_cost is not None:
                    ...
                    ac_nns, retail_market, raw_mat_cost, step, f2,g2,ac_fig)
                else:
