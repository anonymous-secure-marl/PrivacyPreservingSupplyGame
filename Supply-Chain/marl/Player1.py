...
import numpy as np
import supply_game.tree_world_Player1 as world
...
import torch 
import sys
import algorithms_Player1 as alg
...
f = open("SupplyGameResults/SupplyGameRealExecutionResults/Player1/Reward_result_Player1.txt","w")
for l in rewards:
    for ll in l:
        f.write(str(ll))
        f.write("\n")
...
f = open("SupplyGameResults/SupplyGameRealExecutionResults/Player1/sample_policies_result_Player1.txt","w")
...
f = open("SupplyGameResults/SupplyGameRealExecutionResults/Player1/ReplayBufferNew_Player1.txt","w")
